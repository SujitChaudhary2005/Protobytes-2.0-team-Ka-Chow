-- ============================================
-- UPA-NP — Complete Database Migration
-- Supabase SQL Editor — Single file upload
-- ============================================
-- INSTRUCTIONS:
--   1. Open Supabase Dashboard → SQL Editor
--   2. Paste this entire file
--   3. Click "Run"
--   4. Done. All tables, indexes, RLS, realtime, and seed data created.
-- ============================================

-- ============================================
-- STEP 0: Clean slate (drop if re-running)
-- ============================================
...
-- Represents government entities, institutions, and merchants
CREATE TABLE upas (
...
-- Defines what kinds of payments each UPA accepts
CREATE TABLE intents (
  ...
  fixed_amount    DECIMAL(12,2),                  -- if amount_type = "fixed"
  min_amount      DECIMAL(12,2),                  -- if amount_type = "range"
  max_amount      DECIMAL(12,2),                  -- if amount_type = "range"
  metadata_schema JSONB NOT NULL DEFAULT '{}',    -- dynamic fields schema
  upa_id          UUID REFERENCES upas(id) ON DELETE CASCADE,
  created_at      TIMESTAMPTZ DEFAULT NOW()
);

-- 2.3 Transactions (Core Table)
-- Every payment — online or offline — is recorded here
CREATE TABLE transactions (
  ...
  payer_id        VARCHAR(100),                   -- license#, student ID, etc.
  ...
  signature       TEXT,                            -- Ed25519 sig (if offline)
  nonce           VARCHAR(100) UNIQUE,             -- replay prevention
...
-- Tracks offline payments as they sync back to the server
...
-- ============================================
-- STEP 4: Enable Realtime (live dashboard)
-- ============================================
...
-- Hackathon mode: allow all access via anon key
-- ============================================
...
-- ============================================
-- STEP 7: Seed Intents (10 templates)
-- ============================================
...
-- ============================================
-- STEP 8: Seed Transactions (55 realistic entries)
-- ============================================
